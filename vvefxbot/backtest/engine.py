...
class SimulatedTrade:
    ...
    def to_dict(self):
        ...
        return {
            ...
            "tp3_usd": tp3_usd,
            "lot": self.lot,
            "open_bar": "" if self.result == "CANCELLED" else self.open_bar,
            "open_time": "" if self.result == "CANCELLED" else str(self.open_time),
        ...
        for idx in range(_WARMUP_BARS, total_bars):
            ...
            for signal in signals_list:
                ...
                if is_zgmt_signal:
                    ...
                    if is_limit_order:
                        entry_price = signal_entry  # Limit order placed at exactly the specified price
                    else:
